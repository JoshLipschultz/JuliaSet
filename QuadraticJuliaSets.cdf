...
NotebookDataLength[     75991,       1526]
NotebookOptionsPosition[     48885,        942]
NotebookOutlinePosition[     75131,       1503]
CellTagsIndexPosition[     75020,       1497]
WindowTitle->Quadratic Julia Sets
WindowFrame->Normal*)
...
Cell["Quadratic Julia Sets", "DemoTitle",
 CellID->700863240],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`axes$$ = False, $CellContext`l$$ = {0.5, 
    0.5}, $CellContext`n$$ = 10, $CellContext`tr$$ = False, Typeset`show$$ = 
    True, Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`l$$], {0.5, 0.5}}, {-1.5, -1.5}, {1.5, 1.5}}, {{
       Hold[$CellContext`n$$], 10, "number of iterations"}, 0, 13, 1}, {{
       Hold[$CellContext`tr$$], False, "show trails"}, {True, False}}, {{
       Hold[$CellContext`axes$$], False, "show axes"}, {True, False}}}, 
    Typeset`size$$ = {450., {178., 182.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`l$108453$$ = {0, 0}, $CellContext`n$108454$$ = 
    0, $CellContext`tr$108455$$ = False, $CellContext`axes$108456$$ = False}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`axes$$ = 
        False, $CellContext`l$$ = {0.5, 0.5}, $CellContext`n$$ = 
        10, $CellContext`tr$$ = False}, "ControllerVariables" :> {
        Hold[$CellContext`l$$, $CellContext`l$108453$$, {0, 0}], 
        Hold[$CellContext`n$$, $CellContext`n$108454$$, 0], 
        Hold[$CellContext`tr$$, $CellContext`tr$108455$$, False], 
        Hold[$CellContext`axes$$, $CellContext`axes$108456$$, False]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> 
      With[{$CellContext`cf$ = Compile[{{$CellContext`c, 
             Blank[Complex]}, {$CellContext`z, 
             Blank[Complex], 1}}, 
           Flatten[{
             Sqrt[$CellContext`z - $CellContext`c], -
             Sqrt[$CellContext`z - $CellContext`c]}]], $CellContext`x$ = 
         Part[$CellContext`l$$, 1], $CellContext`y$ = 
        ...
        Graphics[
         If[$CellContext`tr$$, 
          MapIndexed[{
            GrayLevel[
             Rescale[
              First[#2], {1, $CellContext`n$$ + 1}, {0.7, 0}]], 
            Point[
             Transpose[{
               Re[#], 
               Im[#]}]]}& , 
           
           NestList[$CellContext`cf$[$CellContext`x$ + 
             I $CellContext`y$, #]& , {0.}, $CellContext`n$$]], 
          Point[
           (Transpose[{
             Re[#], 
             Im[#]}]& )[
            
            Nest[$CellContext`cf$[$CellContext`x$ + I $CellContext`y$, #]& , {
             0.}, $CellContext`n$$]]]], PlotRange -> 1.5, PlotLabel -> 
         Style[$CellContext`c == 
           NumberForm[$CellContext`x$ + I $CellContext`y$, {2, 2}], 14], 
         ImageSize -> {450, 360}, Axes -> $CellContext`axes$$, ImagePadding -> 
         35]], "Specifications" :> {{{$CellContext`l$$, {0.5, 
          0.5}}, {-1.5, -1.5}, {1.5, 1.5}, ControlType -> 
         Locator}, {{$CellContext`n$$, 10, "number of iterations"}, 0, 13, 
         1}, {{$CellContext`tr$$, False, "show trails"}, {
         True, False}}, {{$CellContext`axes$$, False, "show axes"}, {
         True, False}}}, "Options" :> {}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{501., {242., 247.}},
...
Cell[TextData[{
 "The pictures show Julia sets consisting of points generated by iterating \
the complex number transformation ",
 Cell[BoxData[
  FormBox[
   RowBox[{"z", " ", "\[Rule]", 
    RowBox[{"{", 
 ...
 ". The Mandelbrot set can be defined as the set of values of ",
 Cell[BoxData[
  FormBox["c", TraditionalForm]], "InlineMath"],
 " for which such Julia sets are connected."
}], "ManipulateCaption",
 CellID->1044312921],
...
Cell[TextData[{
 ButtonBox["Julia Set",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/JuliaSet.html"], None}],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["Mandelbrot Set",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/MandelbrotSet.html"], None}],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["The Mandelbrot Set",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://www.wolframscience.com/nksonline/page-934b-text"], None}],
 " (",
...
QuadraticJuliaSets&version=0026"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/QuadraticJuliaSets/QuadraticJuliaSets-\
...
Cell[TextData[{
 ...
 ButtonBox["http://demonstrations.wolfram.com/QuadraticJuliaSets/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/QuadraticJuliaSets/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/QuadraticJuliaSets/"]
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[39492, 698, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[39753, 707, 719, 18, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[48063, 917, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 74735, 1486},
 {"Copyright", 74929, 1491}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[584, 21, 34328, 567, 70, "DemonstrationHeader"],
Cell[34915, 590, 61, 1, 70, "DemoTitle",
 CellID->700863240],
Cell[34979, 593, 3766, 78, 70, "Output",
 CellID->2455284],
Cell[38748, 673, 741, 23, 70, "ManipulateCaption",
 CellID->1044312921],
Cell[39492, 698, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[39753, 707, 719, 18, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[40475, 727, 44, 0, 70, "RelatedLinksSection"],
Cell[40522, 729, 558, 20, 70, "RelatedLinks",
 CellID->1150441630],
Cell[41083, 751, 568, 20, 70, "RelatedLinks",
 CellID->1677201469],
Cell[41654, 773, 434, 14, 70, "RelatedLinks",
 CellID->89358306],
Cell[42091, 789, 4793, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[46887, 880, 45, 0, 70, "CitationSection"],
Cell[46935, 882, 773, 20, 70, "Citations"],
Cell[47711, 904, 349, 11, 70, "Author",
 CellID->53974269],
Cell[48063, 917, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
...
(* NotebookSignature CREK9c@j7Css2vQs5woXFcfI *)
